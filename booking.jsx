...
const EXTRAS = [
  ...
  { id: "jacuzzi", title: "Уличное джакузи", price: 2500 },
  { id: "bikes", title: "Велосипеды", price: 600 },
  { id: "sport", title: "Спортинвентарь", price: 0 },
    ...
    <div className="booking" ref={ref}>
      ...
      <div className="booking-extras">
        ...
        {EXTRAS.map((e) => (
          ...
          >
            {e.title}
            <span className="price">{e.price === 0 ? "бесплатно" : `${e.price.toLocaleString("ru")} ₽${e.perPerson ? "/чел" : ""}`}</span>
          </button>
        ))}
      </div>
