...
const STRINGS = {
  ru: {
    ...
    hero_title_b: "Трава",
    hero_title_em: "в пяти минутах от курорта «Красное озеро»",
    hero_sub: "18 коттеджей в сосновом лесу, две дровяные бани и два уличных джакузи, летний бассейн, мини-зоопарк и большая территория для активного отдыха. С животными — добро пожаловать.",
    ...
    section_cottages_lede: "18 коттеджей в сосновом лесу — двухэтажные четырёхместные и один большой на компанию 8–10 человек. Своя кухня, душевая, Smart TV, терраса и Wi-Fi в каждом домике. Заезд с животными разрешён.",
    section_banya_eyebrow: "02 — Баня и джакузи",
    section_banya_title: "Две дровяные бани и два уличных джакузи",
    ...
    section_winter_body: "Трава — удобная база для гостей Красного озера и Золотой долины. Проживание + трансфер до подъёмников по предварительному заказу, групповые заезды райдеров, баня после катания.",
...
const COTTAGES_DATA = [
  {
    ...
    sub: "От 5 000 ₽/сутки",
    photos: [
      "media3/cottage-4p-1.png",
      "media3/cottage-4p-2.png",
      "media3/cottage-4p-3.png",
      "media3/cottage-4p-4.png",
      "media3/cottage-4p-5.png",
      "media3/cottage-4p-6.png",
      "media3/cottage-4p-7.png",
      "media3/cottage-4p-8.png",
    ],
    feats: ["Двухэтажный, 50 м²", "Двуспальная 160×200 + 2 односпальные на 2 этаже", "До 2 доп. мест (еврораскладушка)", "Кухня · индукция · холодильник · микроволновка · чайник", "Душевая · фен · сушильный шкаф", "Smart TV · спутниковое · Wi-Fi", "Терраса · вид на лес"],
    included: "Бельё, полотенца, фен, чай/кофе",
  },
  {
    id: "8p",
    tag: "8–10 мест",
    ...
    photos: [
      "media3/cottage-8p-4.png",
      "media3/cottage-8p-2.png",
      "media3/cottage-8p-1.png",
      "media3/summer-4.png",
    ],
    feats: ["2 спальни + гостиная", "До 10 человек", "Полноценная кухня · чайник", "2 санузла", "Подходит для компании"],
    included: "Бельё, полотенца, чай/кофе.",
  },
];
...
const ACTIVITIES = {
  summer: {
    ...
    items: [
      ...
      { name: "Прокат велосипедов", price: "от 600 ₽/час" },
      { name: "Спортинвентарь", price: "футбол, волейбол, бадминтон" },
      { name: "Открытый тренажёрный зал ", price: "бесплатно" },
      { name: "Детская площадка", price: "бесплатно" },
  ...
  winter: {
    ...
    items: [
      { name: "Красное озеро · 5 мин", price: "трансфер по запросу" },
      { name: "Золотая долина · 5 мин", price: "трансфер по запросу" },
  ...
  always: {
    ...
    items: [
      { name: "Баня × 2 + 2 уличных джакузи", price: "от 4 500 ₽/3 ч" },
      { name: "Контактный зоопарк", price: "бесплатно для гостей" },
...
const FAQ_DATA = [
  ...
  { q: "Можно ли с детьми?", a: "Конечно. Детская площадка, контактный зоопарк, бассейн летом. Дети до 6 лет — без доплаты." },
];
...
function FactsBand() {
  const facts = [
    ...
    { num: "2 + 2", label: "бани + уличных джакузи" },
    ...
    <section className="section" id="cottages">
      <div className="container">
        ...
        <div className="cottage-rules">
          <div className="cottage-rule"><span className="r-ico">🐶</span><div><b>Питомцы</b><span>добро пожаловать</span></div></div>
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div className="winter-resorts">
          <div className="resort">
            ...
            <div className="resort-dist">5 мин на машине</div>
        ...
        <div className="winter-packages">
          ...
          <ul className="winter-list">
            <li><span>Проживание + трансфер до подъёмников</span><span className="muted-light">по предварительному заказу</span></li>
...
function Gallery({ T, season = "summer" }) {
  const summerSlots = [
    ...
    { id: "g3", cls: "g g3", src: "media3/zoo-1.png", alt: "Контактный зоопарк" },
  ...
  const lede = season === "winter"
    ? "Зима в Траве — пар после катания, джакузи под звёздами и хвойный воздух с морозцем."
    : "Лес, парная и джакузи под открытым небом, неспешные завтраки и зимние вечера у костра.";
  return (
    ...
    <section className="section" id="contacts" style={{ background: "var(--cream)" }}>
      <div className="container">
        <div className="s-head">
          ...
          <p className="lede">Менеджеры отвечают с 10:00 до 21:00.</p>
        </div>
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="row">
              ...
              <div className="val">Автобус №898 от м. Парнас · 1,5 ч<br/>На машине — 1 ч от Петербурга<br/>Трансфер из города (платно) — по запросу</div>
            </div>
            <div className="row">
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-bot">
        ...
        <span><a href="legal.html">Юридическая информация</a> · <a href="legal.html#privacy">Политика конфиденциальности</a> · <a href="legal.html#house-rules">Правила проживания</a></span>
      </div>
    </footer>
  );
}
